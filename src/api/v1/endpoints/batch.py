...
from domain.schemas import TaskResult
...
def run_analysis(db: Session = Depends(get_db_session)) -> TaskResult:  # noqa: B008
    """
    ...
    try:
        ...
        task_payload = AnalyzeSongTaskPayload(task_id=db_task.id)
